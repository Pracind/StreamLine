...
- [x] Highlight segments extracted with FFmpeg
- [x] No A/V desync
- [x] Sequential clip naming
- [x] Clips stored in data/output/clips/

---

## Day 10 — Final Highlight Video Assembly

- [x] Clips concatenated in correct order
- [x] Final video encoded
- [x] Playback verified
- [x] File size reasonable
- [x] Export completes unattended

---

## Day 11 — CLI Interface

- [x] Single command execution supported
- [x] Input path configurable
- [x] Progress feedback shown
- [x] Errors surfaced cleanly
- [x] Repeat runs supported

---

## Day 12 — Performance & Stability Pass

- [x] Chunk-level progress logging
- [x] Partial progress resumable
...
- [x] PySide6 window created
- [x] File picker works
- [x] Start button triggers pipeline
...
- [x] FFmpeg bundled
- [x] App runs on clean machine

---

## Phase 1 Exit Criteria

- [x] 1–4 hour VOD → highlight video
